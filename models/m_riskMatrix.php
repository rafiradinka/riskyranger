...
class RiskMatrix {
    ...
    public function generateCartesianRiskMatrix() {
        ...
        // Axis Labels
        $svg .= "<text x='".($svgWidth/2)."' y='".($svgHeight-10)."' text-anchor='middle'>Impact (1-6)</text>";
        $svg .= "<text x='20' y='".($svgHeight/2)."' transform='rotate(-90 20,".($svgHeight/2).")' text-anchor='middle'>Likelihood (1-6)</text>";
